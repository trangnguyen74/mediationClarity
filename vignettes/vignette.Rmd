...
vignette: >
  %\VignetteIndexEntry{mediationClarity}
...
<!-- The additional Section 6 includes some manual code that reminds of the gist of each method. We recommend reading the paper to properly understand the methods and their properties. -->
...
We use a synthetic dataset `synth` that was created based on the PAS trial [@koning2011WhyTargetEarly]. 
...
- either $\omega_1(C)$ or $\mathrm{E}[Y\mid C,A=1]$ is correct specified; and
- either $\omega_0(C)$ is correct, or both $\mathrm{E}[Y\mid C,A=0]$ and $\mathrm{E}[Y_{1M_0}\mid C]$ are correct; and
- either $\omega_\text{x}(C,M)$ or $\mathrm{E}[Y\mid C,M,A=1]$ is correct.
...
- $\omega_0(C)$ is correct; and
- either $\omega_1(C)$ or $\mathrm{E}[Y\mid C,A=1]$ is correct; and
- either $\omega_\text{x}(C,M)$ or $\mathrm{E}[Y\mid C,M,A=1]$ is correct.
...
- either $\omega_1(C)$ or $\mathrm{E}[Y\mid C,A=1]$ is correct; and
- either $\omega_0(C)$ or $\mathrm{E}[Y\mid C,A=0]$ is correct; and
- either $\omega_\text{x}(C,M)$ is correct, or the $M$-related part of$\omega_\text{x}(C,M)$ and $\mathrm{E}[Y_{1M_0}\mid C]$ are correct.
...
- $\mathrm{P}(M\mid C,A=1)$ is correct; and
- either $\omega_1(C)$ or $\mathrm{E}[Y\mid C,A=1]$ is correct; and
- either $\omega_0(C)$ or $\mathrm{E}[Y\mid C,A=0]$ is correct; and
- either $\omega_\text{x}(C,M)$ or $\mathrm{E}[Y\mid C,M,A=1]$ is correct.
...
- either $\omega_1(C)$ or $\mathrm{E}[Y\mid C,A=1]$ is correct specified; and
- either $\omega_0(C)$ is correct, or both $\mathrm{E}[Y\mid C,A=0]$ and $\mathrm{E}[{NDE}_0\mid C]$ are correct; and
- either $\omega_\text{x}(C,M)$ or $\mathrm{E}[Y\mid C,M,A=1]$ is correct.
