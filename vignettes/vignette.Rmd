---
title: "mediationClarity: simple and more robust estimation of marginal natural (in)direct effects"
output: 
...
This vignette is long-form documentation of the package `mediationClarity`, and is also the computing appendix to the manuscript @nguyen2022MediationEstimation titled *Causal mediation analysis: from simple to more robust estimation strategies for marginal natural (in)direct effects.* (arxiv:2102.06048).
