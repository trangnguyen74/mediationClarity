...
Here if the same model form is used for the different outcome given covariates models, the short cut argument `y.c.form` can be used instead of `y.c0.form`, `y.c1.form`, `y10.c.form`.
