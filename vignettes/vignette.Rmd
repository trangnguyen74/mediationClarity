---
title: "mediationClarity: marginal natural (in)direct effects estimation"
subtitle: "simple estimators and more robust estimators"
output: 
...
```
```{r, fig.height=6, fig.width=7.5, fig.align='center', fig.cap="wp-Cadj estimator: key balance plot"}
